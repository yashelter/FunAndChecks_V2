        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QueueUsers_AspNetUsers_CurrentAdminId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QueueUsers_QueueEvents_QueueEventId",
                        column: x => x.QueueEventId,
                        principalTable: "QueueEvents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTaskSubmissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserTaskSubmissions_AspNetUsers_AdminId",
                        column: x => x.AdminId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserTaskSubmissions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserTaskSubmissions_QueueEvents_QueueEventId",
                        column: x => x.QueueEventId,
                        principalTable: "QueueEvents",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserTaskSubmissions_Tasks_TaskId",
                        column: x => x.TaskId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QueueUsers_CurrentAdminId",
                table: "QueueUsers",
                column: "CurrentAdminId");

            migrationBuilder.CreateIndex(
                name: "IX_QueueUsers_QueueEventId",
                table: "QueueUsers",
                column: "QueueEventId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTaskSubmissions_AdminId",
                table: "UserTaskSubmissions",
                column: "AdminId");

            migrationBuilder.CreateIndex(
                name: "IX_UserTaskSubmissions_QueueEventId",
                table: "UserTaskSubmissions",
                column: "QueueEventId");

            migrationBuilder.CreateIndex(
                name: "IX_UserTaskSubmissions_TaskId",
                table: "UserTaskSubmissions",
                column: "TaskId");

            migrationBuilder.CreateIndex(
                name: "IX_UserTaskSubmissions_UserId",
                table: "UserTaskSubmissions",
                column: "UserId");
        }
